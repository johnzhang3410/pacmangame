...
#End Region
    ...
    End Sub
        ...
        If pbxGhost4.Left > 1200 Then        ' Customize
            pbxGhost4.Left = 0
            pbxGhost4.Top = 400
        ElseIf pbxGhost4.Left < 0 Then
            pbxGhost4.Left = 1200
            pbxGhost4.Top = 400
        End If

        If pbxGhost4.Top < 0 Then
            pbxGhost4.Top = 750
            pbxGhost4.Left = 600
        ElseIf pbxGhost4.Top > 750 Then
            pbxGhost4.Top = 0
            pbxGhost4.Left = 600
        End If
        End Sub
    ...
    Private Sub btnNext_Click(sender As System.Object, e As System.EventArgs) Handles btnNext.Click
        Dim LevelNum3 = Level3
        Me.Hide()
        LevelNum3.Show()
        Level3.lblScores.Text = Score.ToString
        Me.StartClock.Enabled = False
        Me.Ghost1MoveClock.Enabled = False
